      ...
      class _OTPSignupPageState extends State<OTPSignupPage> {
        ...
        Future<void> savePhoneNumberToFirestore(String phoneNumber) async {
          try {
            // Add a new document to the "users" collection with the phoneNumber as one of its fields.
            // Replace 'users' with the actual name of your Firestore collection.
            await FirebaseFirestore.instance.collection('users').add({
              'phoneNumber': phoneNumber,
            });
            print('Phone number saved to Firestore successfully.');
          } catch (e) {
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () async {
                                ...
                                await savePhoneNumberToFirestore(phone);
                              },
                              child: Container(
                                width: 390,
                                height: 65,
